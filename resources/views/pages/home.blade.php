        ...
        <section class="flexslider-container" id="flexslider-container-1">
            ...
            <div class="flexslider slider" id="slider-1">
                <ul class="slides">
                    ...
                    <li class="item-1" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{ 'assets/images/homepage-slider-1.jpg' }}) 50% 0%;
	...
	height:100%;">
                    ...
                    <li class="item-2" style="background:			linear-gradient(rgba(0,0,0,0.3),rgba(0,0,0,0.3)),url({{ 'assets/images/homepage-slider-1.jpg' }}) 50% 0%;
	background-size:cover;
	height:100%;">
                        <div class="meta">         
                            <div class="container">
                        ...
                        <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-hotel-offers">
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/hotel-1.jpg' }}" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/hotel-2.jpg' }}" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/hotel-3.jpg' }}" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
                            ...
                            <div class="item">
                                <div class="main-block hotel-block">
                                    <div class="main-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/hotel-4.jpg' }}" class="img-responsive" alt="hotel-img" />
                                        </a>
                                        <div class="main-mask">
                                        	<ul class="list-unstyled list-inline offer-price-1">
                                            	<li class="price">$568.00<span class="divider">|</span><span class="pkg">Avg/Night</span></li>
                         ...
                         <div class="owl-carousel owl-theme owl-custom-arrow" id="owl-tour-offers">
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/tour-1.jpg' }}" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/tour-2.jpg' }}" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/tour-3.jpg' }}" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                            ...
                            <div class="item">
                                <div class="main-block tour-block">
                                    <div class="main-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/tour-4.jpg' }}" class="img-responsive" alt="tour-img" />
                                    	</a>
                                    </div><!-- end offer-img -->
                                	...
                                	<div class="row">
                                    	<div class="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                                        	<div class="main-img cruise-img">
                                            	<a href="#">
                                                <img src="{{ 'assets/images/cruise-1.jpg' }}" class="img-responsive" alt="cruise-img"/>
                        		...
                        		<div class="main-block cruise-block">
                                	<div class="row">
                                    	<div class="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                                        	<div class="main-img cruise-img">
                                            	<a href="#">
                                                <img src="{{ 'assets/images/cruise-2.jpg' }}" class="img-responsive" alt="cruise-img"/>
                                                    <div class="cruise-mask">
                                                        <p>7 Nights, 6 Days</p>
                                                    </div><!-- end cruise-mask -->
                                                </a>
                        		...
                        		<div class="main-block cruise-block">
                                	<div class="row">
                                    	<div class="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                                        	<div class="main-img cruise-img">
                                            	<a href="#">
                                                <img src="{{ 'assets/images/cruise-3.jpg' }}" class="img-responsive" alt="cruise-img"/>
                                                    <div class="cruise-mask">
                                                        <p>7 Nights, 6 Days</p>
                                                    </div><!-- end cruise-mask -->
                                                </a>
                        		...
                        		<div class="main-block cruise-block">
                                	<div class="row">
                                    	<div class="col-sm-12 col-md-6 col-md-push-6 no-pd-l">
                                        	<div class="main-img cruise-img">
                                            	<a href="#">
                                                <img src="{{ 'assets/images/cruise-4.jpg' }}" class="img-responsive" alt="cruise-img"/>
                                                    <div class="cruise-mask">
                                                        <p>7 Nights, 6 Days</p>
                                                    </div><!-- end cruise-mask -->
                                                </a>
                        ...
                        <div class="row">
                        	...
                        	<div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        ...
                                        <img src="{{ 'assets/images/flight-1.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        <div class="flight-img">
                                        <img src="{{ 'assets/images/flight-2.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        <div class="flight-img">
                                        <img src="{{ 'assets/images/flight-3.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        <div class="flight-img">
                                        <img src="{{ 'assets/images/flight-4.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        <div class="flight-img">
                                        <img src="{{ 'assets/images/flight-5.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block flight-block">
                                    <a href="#">
                                        <div class="flight-img">
                                        <img src="{{ 'assets/images/flight-6.jpg' }}" class="img-responsive" alt="flight-img" />
                                        </div><!-- end flight-img -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block vehicle-block">
                                    <div class="main-img vehicle-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/vehicle-1.jpg' }}" class="img-responsive" alt="tour-img" />
                                        </a>
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block vehicle-block">
                                    <div class="main-img vehicle-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/vehicle-2.jpg' }}" class="img-responsive" alt="tour-img" />
                                        </a>
                                        <div class="vehicle-time">
                                        	<p><span><i class="fa fa-clock-o"></i></span>22/h</p>
                                        </div><!-- end vehicle-time -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block vehicle-block">
                                    <div class="main-img vehicle-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/vehicle-3.jpg' }}" class="img-responsive" alt="tour-img" />
                                        </a>
                                        <div class="vehicle-time">
                                        	<p><span><i class="fa fa-clock-o"></i></span>22/h</p>
                                        </div><!-- end vehicle-time -->
        		...
        		<div class="row">
        			<div class="col-sm-12">
                        ...
                        <div class="carousel slide" data-ride="carousel" id="quote-carousel">
                            ...
                            <li data-target="#quote-carousel" data-slide-to="0" class="active"><img src="{{ 'assets/images/client-1.jpg' }}" class="img-responsive"  alt="client-img">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="1"><img src="{{ 'assets/images/client-2.jpg' }}" class="img-responsive"  alt="client-img">
                                </li>
                                <li data-target="#quote-carousel" data-slide-to="2"><img src="{{ 'assets/images/client-3.jpg' }}" class="img-responsive"  alt="client-img">
                                </li>
                            </ol>
                        ...
                        <div class="row">
                             ...
                             <div class="col-sm-6 col-md-4">
                                <div class="main-block latest-block">
                                    <div class="main-img latest-img">
                                    	<a href="#">
                                        <img src="{{ 'assets/images/latest-blog-1.jpg' }}" class="img-responsive" alt="blog-img" />
                                        </a>
                                    </div><!-- end latest-img -->
                            ...
                            <div class="col-sm-6 col-md-4">
                                <div class="main-block latest-block">
                                    <div class="main-img latest-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/latest-blog-2.jpg' }}" class="img-responsive" alt="blog-img" />
                                        </a>
                                    </div><!-- end latest-img -->
                             ...
                             <div class="col-sm-6 col-md-4">
                                <div class="main-block latest-block">
                                    <div class="main-img latest-img">
                                        <a href="#">
                                        <img src="{{ 'assets/images/latest-blog-3.jpg' }}" class="img-responsive" alt="blog-img" />
                                        </a>
                                    </div><!-- end latest-img -->
